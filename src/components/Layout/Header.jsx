        ...
        <div className="px-6 py-6">
          <div className="flex justify-between items-end gap-8">
            ...
            <div className="flex items-end gap-6">
              ...
              >
                <div className="w-9 h-9 flex flex-col justify-center items-center space-y-2">
                  <span
              ...
              <Link href="/">
                <div className="w-[92px] h-[92px] rounded-full bg-white flex items-center justify-center p-2">
                  <Image
