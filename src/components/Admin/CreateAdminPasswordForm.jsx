...
export default function CreateAdminPasswordForm() {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      try {
        ...
        // Check if user is in admin_accounts table by user_id
        ...
        // Check if already completed password setup
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-900">
        <div className="text-white text-lg">Verifying credentials...</div>
      </div>
    );
  }
